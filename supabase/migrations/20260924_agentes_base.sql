-- Agentes de IA: tabelas agente_* e funções de escrita. Aplicada em 2026-09-24 (migration "agentes_base").
-- Desenho e justificativas: agentes/SCHEMA.md. Decisões: agentes/PLANO.md (D1–D9, N1–N4).
-- Origem: agentes/schema-rascunho.sql (bateria agentes/schema-testes.sql: 33 de 33 antes e depois de aplicar).
--
